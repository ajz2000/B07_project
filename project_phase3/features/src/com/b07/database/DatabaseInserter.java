...
public class DatabaseInserter {
   ...
   */
  protected static int insertNewUser(
      String name, int age, String address, String password, Connection connection)
      throws DatabaseInsertException {
   ...
   * @throws DatabaseInsertException if something goes wrong.
   */
  protected static int insertItemizedSale(
      int saleId, int itemId, int quantity, Connection connection) throws DatabaseInsertException {
   ...
   * @throws DatabaseInsertException if something goes wrong.
   */
  protected static int insertAccountLine(
      int accountId, int itemId, int quantity, Connection connection)
      throws DatabaseInsertException {
  ...
  protected static int insertCoupon(
      int uses, int typeId, int itemId, BigDecimal discount, String code, Connection connection)
      throws DatabaseInsertException {
